...
<main>
		...
		<div class="files-container">
			<div class="files-list">
				{#each uploadedFiles as file, index (index)}
					<div class="file-item">
						<img src={URL.createObjectURL(file.file)} alt="Vorschau" class="file-preview" />
						<div class="file-info">
							<input
								type="text"
								placeholder="Titel"
							...
							<!-- <textarea
								...
								rows="2"
							></textarea> -->
							<select bind:value={file.type} disabled={isUploading} class="file-input">
			...
			<div class="actions">
				<button onclick={handleClick} disabled={isUploading} class="add-more-btn">
					+ Weitere Fotos hinzufügen
				</button>
				<button onclick={handleUpload} disabled={isUploading} class="upload-btn">
	...
	<input type="file" id="fileInput" multiple accept="image/*" onchange={handleFileChange} hidden />
</main>
